...
public:
    ...
    void generate() {
        ...
        conv1(c, x, y, n) =
            conv_fixed32<ImageParam, FB>(input, conv1_weight, conv1_bias,
                                         conv1_weight_shape, conv1_stride,
                                         conv1_pad, input_shape,
                                         conv1_top_shape)(c, x, y, n);

        // Bn1
        Func bn1("bn1");
        std::vector<int32_t> bn1_top_shape;
        bn1(c, x, y, n) =
            bn_fixed32<ImageParam, FB>(conv1, bn1_mean,
                                       bn1_variance, conv1_top_shape,
                                       bn1_top_shape)(c, x, y, n);

        // Scale1
        Func scale1("scale1");
        std::vector<int32_t> scale1_top_shape;
        scale1(c, x, y, n) =
            scale_fixed32<ImageParam, FB>(bn1, scale1_weight,
                                          scale1_bias, bn1_top_shape,
                                          scale1_top_shape)(c, x, y, n);

        // ReLU1
        relu1(c, x, y, n) =
            relu(scale1, scale1_top_shape, relu1_top_shape)(c, x, y, n);
        ...
        pool1(c, x, y, n) =
            pool_fixed32<FB>(relu1, pool1_window_shape,
                             pool1_stride, relu1_top_shape,
        ...
        bn2(c, x, y, n) =
            bn_fixed32<ImageParam, FB>(pool1, bn2_mean,
                                       bn2_variance, pool1_top_shape,
                                       bn2_top_shape)(c, x, y, n);

        // Scale2
        Func scale2("scale2");
        std::vector<int32_t> scale2_top_shape;
        scale2(c, x, y, n) =
            scale_fixed32<ImageParam, FB>(bn2, scale2_weight,
                                          scale2_bias, bn2_top_shape,
                                          scale2_top_shape)(c, x, y, n);

        // Active2
        active2(c, x, y, n) =
            bin_active_fixed32<FB>(scale2, scale2_top_shape,
                                   active2_top_shape)(c, x, y, n);

        // Conv2(96x5x5x256): (96, 28, 28, n) -> (256, 28, 28, n)
        conv2(c, x, y, n) =
            bin_conv_fixed32<ImageParam, FB>(active2, conv2_weight,
                                             conv2_alpha, conv2_bias,
                                             conv2_weight_shape,
                                             active2_top_shape,
                                             conv2_top_shape)(c, x, y, n);
        ...
        pool2(c, x, y, n) =
            pool_fixed32<FB>(conv2, pool2_window_shape,
                             pool2_stride, conv2_top_shape,
        ...
        bn3(c, x, y, n) =
            bn_fixed32<ImageParam, FB>(pool2, bn3_mean,
                                       bn3_variance, pool2_top_shape,
                                       bn3_top_shape)(c, x, y, n);

        // Scale3
        Func scale3("scale3");
        std::vector<int32_t> scale3_top_shape;
        scale3(c, x, y, n) =
            scale_fixed32<ImageParam, FB>(bn3, scale3_weight,
                                          scale3_bias, bn3_top_shape,
                                          scale3_top_shape)(c, x, y, n);

        // Active3
        active3(c, x, y, n) =
            bin_active_fixed32<FB>(scale3, scale3_top_shape,
                                   active3_top_shape)(c, x, y, n);

        // Conv3(256x3x3x384): (256, 13, 13, n) -> (384, 13, 13, n)
        Func conv3("conv3");
        conv3(c, x, y, n) =
            bin_conv_fixed32<ImageParam, FB>(active3, conv3_weight,
                                             conv3_alpha, conv3_bias,
                                             conv3_weight_shape,
                                             active3_top_shape,
                                             conv3_top_shape)(c, x, y, n);

        // Bn4
        Func bn4("bn4");
        std::vector<int32_t> bn4_top_shape;
        bn4(c, x, y, n) =
            bn_fixed32<ImageParam, FB>(conv3, bn4_mean,
                                       bn4_variance, conv3_top_shape,
                                       bn4_top_shape)(c, x, y, n);

        // Scale4
        Func scale4("scale4");
        std::vector<int32_t> scale4_top_shape;
        scale4(c, x, y, n) =
            scale_fixed32<ImageParam, FB>(bn4, scale4_weight,
                                          scale4_bias, bn4_top_shape,
                                          scale4_top_shape)(c, x, y, n);

        // Active4
        active4(c, x, y, n) =
            bin_active_fixed32<FB>(scale4, scale4_top_shape,
                                   active4_top_shape)(c, x, y, n);

        // Conv4(384x3x3x384): (384, 14, 14, n) -> (384, 14, 14, n)
        Func conv4("conv4");
        conv4(c, x, y, n) =
            bin_conv_fixed32<ImageParam, FB>(active4, conv4_weight,
                                             conv4_alpha, conv4_bias,
                                             conv4_weight_shape,
                                             active4_top_shape,
                                             conv4_top_shape)(c, x, y, n);

        // Bn5
        Func bn5("bn5");
        std::vector<int32_t> bn5_top_shape;
        bn5(c, x, y, n) =
            bn_fixed32<ImageParam, FB>(conv4, bn5_mean,
                                       bn5_variance, conv4_top_shape,
                                       bn5_top_shape)(c, x, y, n);

        // Scale5
        Func scale5("scale5");
        std::vector<int32_t> scale5_top_shape;
        scale5(c, x, y, n) =
            scale_fixed32<ImageParam, FB>(bn5, scale5_weight,
                                          scale5_bias, bn5_top_shape,
                                          scale5_top_shape)(c, x, y, n);

        // Active5
        active5(c, x, y, n) =
            bin_active_fixed32<FB>(scale5, scale5_top_shape,
                                   active5_top_shape)(c, x, y, n);

        // Conv5(384x3x3x256): (384, 13, 13, n) -> (256, 14, 14, n)
        conv5(c, x, y, n) =
            bin_conv_fixed32<ImageParam, FB>(active5, conv5_weight,
                                             conv5_alpha, conv5_bias,
                                             conv5_weight_shape,
                                             active5_top_shape,
                                             conv5_top_shape)(c, x, y, n);
        ...
        pool5(c, x, y, n) =
            pool_fixed32<FB>(conv5, pool5_window_shape,
                             pool5_stride, conv5_top_shape,
                             pool5_top_shape)(c, x, y, n);

        // Bn6
        Func bn6("bn6");
        std::vector<int32_t> bn6_top_shape;
        bn6(c, x, y, n) =
            bn_fixed32<ImageParam, FB>(pool5, bn6_mean,
                                       bn6_variance, pool5_top_shape,
                                       bn6_top_shape)(c, x, y, n);

        // Scale6
        Func scale6("scale6");
        std::vector<int32_t> scale6_top_shape;
        scale6(c, x, y, n) =
            scale_fixed32<ImageParam, FB>(bn6, scale6_weight,
                                          scale6_bias, bn6_top_shape,
                                          scale6_top_shape)(c, x, y, n);

        // Active6
        active6(c, x, y, n) =
            bin_active(scale6, scale6_top_shape, active6_top_shape)(c, x, y, n);

        // Fc6(256x6x6x4096): (256, 6, 6, n) -> (4096, 1, 1, n)
        Func fc6("fc6");
        fc6(c, x, y, n) =
            bin_conv_fixed32<ImageParam, FB>(active6, fc6_weight,
                                             fc6_alpha, fc6_bias,
                                             fc6_weight_shape, 1, 0,
                                             active6_top_shape,
                                             fc6_top_shape)(c, x, y, n);

        // Bn7
        Func bn7("bn7");
        std::vector<int32_t> bn7_top_shape;
        bn7(c, x, y, n) =
            bn_fixed32<ImageParam, FB>(fc6, bn7_mean,
                                       bn7_variance, fc6_top_shape,
                                       bn7_top_shape)(c, x, y, n);

        // Scale7
        Func scale7("scale7");
        std::vector<int32_t> scale7_top_shape;
        scale7(c, x, y, n) =
            scale_fixed32<ImageParam, FB>(bn7, scale7_weight,
                                          scale7_bias, bn7_top_shape,
                                          scale7_top_shape)(c, x, y, n);

        // Active7
        active7(c, x, y, n) =
            bin_active_fixed32<FB>(scale7, scale7_top_shape,
                                   active7_top_shape)(c, x, y, n);

        // Fc7(4096x1x1x4096): (4096, 1, 1, n) -> (4096, 1, 1, n)
        Func fc7("fc7");
        fc7(c, x, y, n) =
            bin_conv_fixed32<ImageParam, FB>(active7, fc7_weight,
                                             fc7_alpha, fc7_bias,
                                             fc7_weight_shape, 1, 0,
                                             active7_top_shape,
                                             fc7_top_shape)(c, x, y, n);

        // Bn8
        Func bn8("bn8");
        std::vector<int32_t> bn8_top_shape;
        bn8(c, x, y, n) =
            bn_fixed32<ImageParam, FB>(fc7, bn8_mean,
                                       bn8_variance, fc7_top_shape,
                                       bn8_top_shape)(c, x, y, n);

        // Scale8
        Func scale8("scale8");
        std::vector<int32_t> scale8_top_shape;
        scale8(c, x, y, n) =
            scale_fixed32<ImageParam, FB>(bn8, scale8_weight,
                                          scale8_bias, bn8_top_shape,
                                          scale8_top_shape)(c, x, y, n);

        // relu8
        relu8(c, x, y, n) =
            relu(scale8, scale8_top_shape, relu8_top_shape)(c, x, y, n);

        // Fc8(4096x1x1x1000): (4096, 1, 1, n) -> (1000, 1, 1, n)
        fc8(c, x, y, n) =
            conv_fixed32<ImageParam, FB>(relu8, fc8_weight,
                                         fc8_bias, fc8_weight_shape, 1, 0,
                                         relu8_top_shape,
                                         fc8_top_shape)(c, x, y, n);
    ...
    void schedule() {
        if (auto_schedule) {
            in.set_estimates({{0, input_shape[0]},
                              ...
                              {0, input_shape[2]},
                              {0, input_shape[3]}});
            conv1_weight.set_estimates({{3, 1},
                                        {11, 1},
                                        {11, 1},
                                        {conv1_num_output, 1}});
            conv1_bias.set_estimates({{conv1_num_output, 1}});
            bn1_mean.set_estimates({{conv1_num_output, 1}});
            bn1_variance.set_estimates({{conv1_num_output, 1}});
            scale1_weight.set_estimates({{conv1_num_output, 1}});
            scale1_bias.set_estimates({{conv1_num_output, 1}});

            bn2_mean.set_estimates({{conv1_num_output, 1}});
            bn2_variance.set_estimates({{conv1_num_output, 1}});
            scale2_weight.set_estimates({{conv1_num_output, 1}});
            scale2_bias.set_estimates({{conv1_num_output, 1}});

            conv2_weight.set_estimates({{conv1_num_output, 1},
                                        {5, 1},
                                        {5, 1},
                                        {conv2_num_output, 1}});
            conv2_alpha.set_estimates({{conv2_num_output, 1}});
            conv2_bias.set_estimates({{conv2_num_output, 1}});

            bn3_mean.set_estimates({{conv2_num_output, 1}});
            bn3_variance.set_estimates({{conv2_num_output, 1}});
            scale3_weight.set_estimates({{conv2_num_output, 1}});
            scale3_bias.set_estimates({{conv2_num_output, 1}});

            conv3_weight.set_estimates({{conv2_num_output, 1},
                                        {3, 1},
                                        {3, 1},
                                        {conv3_num_output, 1}});
            conv3_alpha.set_estimates({{conv3_num_output, 1}});
            conv3_bias.set_estimates({{conv3_num_output, 1}});

            bn4_mean.set_estimates({{conv3_num_output, 1}});
            bn4_variance.set_estimates({{conv3_num_output, 1}});
            scale4_weight.set_estimates({{conv3_num_output, 1}});
            scale4_bias.set_estimates({{conv3_num_output, 1}});

            conv4_weight.set_estimates({{conv3_num_output, 1},
                                        {3, 1},
                                        {3, 1},
                                        {conv4_num_output, 1}});
            conv4_alpha.set_estimates({{conv4_num_output, 1}});
            conv4_bias.set_estimates({{conv4_num_output, 1}});

            bn5_mean.set_estimates({{conv4_num_output, 1}});
            bn5_variance.set_estimates({{conv4_num_output, 1}});
            scale5_weight.set_estimates({{conv4_num_output, 1}});
            scale5_bias.set_estimates({{conv4_num_output, 1}});

            conv5_weight.set_estimates({{conv4_num_output, 1},
                                        {3, 1},
                                        {3, 1},
                                        {conv5_num_output, 1}});
            conv5_alpha.set_estimates({{conv5_num_output, 1}});
            conv5_bias.set_estimates({{conv5_num_output, 1}});

            bn6_mean.set_estimates({{conv5_num_output, 1}});
            bn6_variance.set_estimates({{conv5_num_output, 1}});
            scale6_weight.set_estimates({{conv5_num_output, 1}});
            scale6_bias.set_estimates({{conv5_num_output, 1}});

            fc6_weight.set_estimates({{conv5_num_output, 1},
                                      {6, 1},
                                      {6, 1},
                                      {fc6_num_output, 1}});
            fc6_alpha.set_estimates({{fc6_num_output, 1}});
            fc6_bias.set_estimates({{fc6_num_output, 1}});

            bn7_mean.set_estimates({{fc6_num_output, 1}});
            bn7_variance.set_estimates({{fc6_num_output, 1}});
            scale7_weight.set_estimates({{fc6_num_output, 1}});
            scale7_bias.set_estimates({{fc6_num_output, 1}});

            fc7_weight.set_estimates({{fc6_num_output, 1},
                                      {1, 1},
                                      {1, 1},
                                      {fc7_num_output, 1}});
            fc7_alpha.set_estimates({{fc7_num_output, 1}});
            fc7_bias.set_estimates({{fc7_num_output, 1}});

            bn8_mean.set_estimates({{fc7_num_output, 1}});
            bn8_variance.set_estimates({{fc7_num_output, 1}});
            scale8_weight.set_estimates({{fc7_num_output, 1}});
            scale8_bias.set_estimates({{fc7_num_output, 1}});

            fc8_weight.set_estimates({{fc7_num_output, 1},
                                      {1, 1},
                                      {1, 1},
                                      {fc8_num_output, 1}});
            fc8_bias.set_estimates({{fc8_num_output, 1}});

            prob.set_estimates({{0, fc8_num_output}, {0, input_shape[3]}});
        } else {
            // Schedule
...
private:
    ...
    std::vector<int32_t> input_shape{3, 224, 224, 1};
    constexpr static size_t FB = 16;
