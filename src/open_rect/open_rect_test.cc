...
template<typename T>
int conv_rect(int width, int height, int depth, int window_width, int window_height, int iteration,
...
int test(int (*func)(struct halide_buffer_t *_src_buffer, struct halide_buffer_t *_workbuf__1_buffer))
{
    try {
        ...
        // erode
        int k = conv_rect(width, height, depth, window_width, window_height, iteration,
