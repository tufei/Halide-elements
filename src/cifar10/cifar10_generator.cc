...
public:
    ...
    void generate() {
        ...
        Fixed<int32_t, FB> mean =
            to_fixed<int32_t, FB>(mux(c, {0.4914f, 0.4822f, 0.4465f}));
        Fixed<int32_t, FB> std =
            to_fixed<int32_t, FB>(mux(c, {0.2023f, 0.1994f, 0.2010f}));
        input(c, x, y, n) =
            static_cast<Expr>((Fixed<int32_t, FB>{in(c, x, y, n)} - mean) / std);

        // Lq1_1
        lq1_1(c, x, y, n) =
            log_quant_fixed32<FB>(input, input_shape,
                                  lq1_1_top_shape)(c, x, y, n);

        // Conv1_1(3x5x5x192): (3, 32, 32, n) -> (192, 32, 32, n)
        Func conv1_1{"conv1_1"};
        std::vector<int32_t> conv1_1_top_shape;
        conv1_1(c, x, y, n) =
            conv_qq_fixed32<Buffer<>, FB>(lq1_1, c11wq, c11b, c11w_shape,
                                          lq1_1_top_shape,
                                          conv1_1_top_shape)(c, x, y, n);

        // Bn1_1
        Func bn1_1{"bn1_1"};
        std::vector<int32_t> bn1_1_top_shape;
        bn1_1(c, x, y, n) =
            bn_fixed32<Buffer<>, FB>(conv1_1, bn11m, bn11v,
                                     conv1_1_top_shape,
                                     bn1_1_top_shape)(c, x, y, n);

        // ReLU1_1:
        Func relu1_1{"relu1_1"};
        std::vector<int32_t> relu1_1_top_shape;
        relu1_1(c, x, y, n) =
            relu(bn1_1, bn1_1_top_shape, relu1_1_top_shape)(c, x, y, n);
        ...
        bn3_3(c, x, y, n) =
            bn_fixed32<Buffer<>, FB>(conv3_2, bn33m, bn33v, conv3_2_top_shape,
                                     bn3_3_top_shape)(c, x, y, n);

        // Lq3_3
        lq3_3(c, x, y, n) =
            log_quant_fixed32<FB>(bn3_3, bn3_3_top_shape,
                                  lq3_3_top_shape)(c, x, y, n);

        // Conv3_3(192x1x1x10): (192, 8, 8, n) -> (10, 8, 8, n)
        Func conv3_3("conv3_3");
        std::vector<int32_t> conv3_3_top_shape;
        conv3_3(c, x, y, n) =
            conv_qq_fixed32<Buffer<>, FB>(lq3_3, c33wq, c33b, c33w_shape,
                                          lq3_3_top_shape,
                                          conv3_3_top_shape)(c, x, y, n);

        // ReLU3_3:
        relu3_3(c, x, y, n) =
            relu(conv3_3, conv3_3_top_shape, relu3_3_top_shape)(c, x, y, n);

        // Pool3(8x8, 1): (10, 8, 8, n) -> (10, 1, 1, n)
        Func pool3("pool3");
        std::vector<int32_t> pool3_top_shape;
        pool3(c, n) =
            global_avgpool_fixed32<FB>(relu3_3, relu3_3_top_shape,
                                       pool3_top_shape)(c, n);
...
private:
    ...
    Func conv1_3{"conv1_3"};
    std::vector<int32_t> conv1_3_top_shape;

    Func conv2_3{"conv2_3"};
